/**
 * Footprint map: India outline with glowing markers for Rajasthan, Delhi NCR, Uttar Pradesh, and Chennai.
 */
import { FOOTPRINT_MARKERS, INDIA_MAINLAND_PATH, INDIA_MAP_VIEWBOX } from '../../data/indiaMapOutline';

const MARKER_ORDER = ['rajasthan', 'delhiNcr', 'uttarPradesh', 'chennai'] as const;
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-14">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
            ...
            presence in Rajasthan, Uttar Pradesh, Delhi NCR, and Chennai (Tamil Nadu).
          </p>
        </div>
            ...
            <div className="relative rounded-3xl border-2 border-primary/15 bg-gradient-to-br from-slate-900 via-slate-800 to-primary-dark p-6 sm:p-8 md:p-10 shadow-2xl shadow-primary/25 overflow-hidden">
              ...
              <div className="relative mx-auto max-w-xl w-full">
                <svg
                  ...
                  role="img"
                  aria-label="Map of India with highlighted regions including Rajasthan, Delhi NCR, Uttar Pradesh, and Chennai"
                >
                  <defs>
                  ...
                  {MARKER_ORDER.map((id) => {
                    ...
                    return (
                      <g key={id} filter={`url(#${m.filter})`}>
                        ...
                        <text
                          x={m.cx}
                          y={m.cy + (isDelhi ? 26 : m.cy > 500 ? -18 : 30)}
                          textAnchor="middle"
                          fill="#f8fafc"
                          fontSize={isDelhi ? 10 : m.cy > 500 ? 10 : 11}
                          fontWeight="600"
              ...
              <p className="relative mt-6 text-center text-xs text-slate-300/90 max-w-md mx-auto leading-relaxed">
                Outline based on India’s national boundary (simplified). Markers: Jaipur area (Rajasthan), Delhi NCR,
